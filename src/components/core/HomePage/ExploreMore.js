...
const tabsName = [
 ...
 const ExploreMore = () => {
  ...
  return (
    ...
    <div className="hidden lg:flex gap-5 mt-5 mx-auto w-max bg-richblack-800 text-richblack-200
    ...
    <div className="hidden lg:block lg:h-[200px]"></div>
        ...
        {/* course car ka group */}
      <div className="lg:absolute gap-16 flex lg:flex-row lg:translate-x-[-10%] lg:translate-y-[-50%] flex-col">
