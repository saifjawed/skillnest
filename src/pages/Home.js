...
const Home = () => {
  return (
    <div>
        {/* Section 1 */}
        <div className=" max-w-maxContent realtive mx-auto flex flex-col w-11/12 items-center text-white justify-between">

            <Link to={"/signup"}>
                <div className=" mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200
                drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 w-fit">
                    <div className="flex flex-row items-center gap-2 rounded-dull px-10 py-[5px]
                     transition-all duration-200 hover:bg-richblack-900 rounded-full">
